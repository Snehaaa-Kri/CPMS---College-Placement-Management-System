...
function Signup() {
  ...
  setToastMessage("Backend not reachable");
}
setShowToast(true);
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center py-2 min-h-screen bg-[#904F09] ">
        <form className="form-signin flex justify-center items-center flex-col gap-3 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-8 w-1/3 max-lg:w-2/3 max-md:w-3/4 max-[400px]:w-4/5" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center items-center flex-col">
            <button
              className="bg-[#301A03] text-white px-6 py-2 rounded-md hover:bg-[#F0830F] transition duration-200"
              type="submit"
            >
              Sign Up
            </button>
          ...
          <span className='text-center'>Already having account?
            <span className='text-[#603406] font-bold cursor-pointer px-1' onClick={() => navigate('../student/login')}>Login</span>
          </span>
